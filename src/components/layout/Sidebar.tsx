...
export function Sidebar({ collapsed, onToggle }: SidebarProps) {
  ...
  const navItems = [
    ...
    { name: 'Competency & Career', href: '/career', icon: Award },
    { name: 'Knowledge Rewards', href: '/rewards', icon: Gift },
    { name: 'Compensation', href: '/compensation', icon: Award },
    { name: 'Bonus & Payments', href: '/payments', icon: Clock },
    ...
    { name: 'Platform Settings', href: '/settings/modules', icon: Layers },
    { name: 'Audit Logs', href: '/settings/audit', icon: Shield },
